...
type BestsellersSectionProps = {
  section: BestsellersSectionData | null;
};
...
export function BestsellersSection({ section }: BestsellersSectionProps) {
  ...
  const title = section.title ?? "Хиты продаж";

  return (
    <section aria-labelledby="bestsellers-heading" className="bg-background">
      <Container as="div" className="pb-14 pt-6 sm:pb-20 sm:pt-8 lg:pb-24">
